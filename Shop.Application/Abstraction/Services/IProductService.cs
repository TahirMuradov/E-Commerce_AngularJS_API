...
namespace Shop.Application.Abstraction.Services
{
    public interface IProductService
    {
        ...
        public Task<IDataResult<GetProductDetailDTO>> GetProductByIdAsync(Guid id, string LangCode);
        public Task<IDataResult<GetProductForUpdateDTO>> GetProductByIdForUpdateAsync(Guid id, string LangCode);
