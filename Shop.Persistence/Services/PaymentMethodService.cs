...
namespace Shop.Persistence.Services
{
    public class PaymentMethodService : IPaymentMethodService
    {
        ...
        {
            if (string.IsNullOrEmpty(locale) || !SupportedLaunguages.Contains(locale))
                return new ErrorDataResult<IQueryable<GetPaymentMethodDTO>>(message: HttpStatusErrorMessages.UnsupportedLanguage[DefaultLaunguage], HttpStatusCode.UnsupportedMediaType);
        ...
        public IDataResult<GetPaymentMethodDetailDTO> GetPaymentMethodById(Guid id, string locale)
        {
            ...
            return new SuccessDataResult<GetPaymentMethodDetailDTO>(getPaymentMethodDTO, message: HttpStatusErrorMessages.Success[locale], HttpStatusCode.OK);
        }
